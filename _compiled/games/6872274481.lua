...
run(function()
	...
	for i, v in remoteNames do
		...
		if remote == '' then
			notif('FadeWare', 'Failed to grab remote ('..i..')', 10, 'alert')
		end
		remotes[i] = remote
	end
...
vape.Components.HotbarList = function(optionsettings, children, api)
	...
	textbuttonicon.Image = getcustomasset('fadeware/assets/new/add.png')
		...
		local mounted = bedwars.Roact.mount(create('BillboardGui', {
			...
			create('Frame', {
				...
				create('ImageLabel', {
					...
					BackgroundTransparency = 1,
					Image = getcustomasset('fadeware/assets/new/blur.png'),
