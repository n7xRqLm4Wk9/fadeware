...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/n7xRqLm4Wk9/fadeware/main/_compiled/'..select(1, path:gsub('fadeware/', '')), true) end)
