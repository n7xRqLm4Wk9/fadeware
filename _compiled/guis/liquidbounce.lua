...
local getcustomassets = {
	['fadeware/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['fadeware/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['fadeware/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['fadeware/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['fadeware/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['fadeware/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['fadeware/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['fadeware/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['fadeware/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['fadeware/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('fadeware/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('fadeware/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('fadeware/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('fadeware/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('fadeware/assets/liquidbounce/lbfont.json')
end

if inputService.TouchEnabled then
	writefile('fadeware/profiles/gui.txt', 'new')
	return
end
...
components = {
--Components
	Bind = function(optionsettings, children, moduleapi)
...
dropdownexpand.Image = getcustomasset('fadeware/assets/liquidbounce/expand.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('fadeware/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('fadeware/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('fadeware/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('fadeware/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('fadeware/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('fadeware/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('fadeware/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('fadeware/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
