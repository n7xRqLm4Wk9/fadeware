...
local getcustomassets = {
	['fadeware/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/n7xRqLm4Wk9/fadeware/'..readfile('fadeware/profiles/commit.txt')..'/'..select(1, path:gsub('fadeware/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('fadeware/assets/wurst/triangle.png')
