...
local hash = loadstring(downloadFile('fadeware/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('fadeware/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('fadeware/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
	tagcallback = {},
